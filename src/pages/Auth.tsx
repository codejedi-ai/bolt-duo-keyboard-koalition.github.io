...
function Auth(): JSX.Element {
  ...
  const handleDiscordCallback = async (code: string) => {
    ...
    try {
      ...
      // Success will be handled by the auth provider redirect
    } catch (err: any) {
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900 p-8 rounded-lg border border-gray-800 space-y-6">
          ...
          <button
            ...
            disabled={isSubmitting || isLoading}
            className="w-full bg-[#5865F2] hover:bg-[#4752C4] disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-2 px-4 rounded-md transition-colors flex items-center justify-center gap-2"
          >
